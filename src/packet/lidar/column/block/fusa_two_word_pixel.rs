...
#[derive(Debug, Eq, PartialEq, Clone, Serialize, Deserialize, derive_new::new)]
pub struct FuSaDualReturnBlock {
    pub range: u32,
    pub reflectivity: u8,
...
impl Default for FuSaDualReturnBlock {
    fn default() -> Self {
        Self {
            range: 0,
            reflectivity: 0,
...
impl BinRead for FuSaDualReturnBlock {
    type Args<'a> = ();
...
impl BinWrite for FuSaDualReturnBlock {
    type Args<'a> = ();
